...
<div id="m">
<div class ="om" id="btn_medico"><input type="button" value="Medico"></div>
<div class ="om" id="btn_estudio"><input type="button"value="Estudio"></div>
<div class ="om"  id="btn_turno"><input type="button" value="Turno"> </div>
