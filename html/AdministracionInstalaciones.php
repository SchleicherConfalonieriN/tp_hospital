...
<form action="../controllers/AgregarEspecialidad.php" method="POST">
	<label>Colocar Numero de Consultorio</label>
	<input type="text" name="especialidad" minlength="3" maxlength="30" required="required">
...
<tr><td><?= htmlentities($esp['especialidad_id'])?></td>
	<td><?= htmlentities($esp['nom_especialidad'])?></td>  
